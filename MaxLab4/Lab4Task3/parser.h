...
//#include "../_string_/_string__global.h"

//#include "../_string_/_string.h"
...
public:
    ...
    void parse() {
        ...
        info += "\n\nКоличество классов:\t"; info += std::to_string(classes);
        info += "\nКоличество структур:\t"; info += std::to_string(structs);
        info += "\nКоличество массивов:\t"; info += std::to_string(arrs);

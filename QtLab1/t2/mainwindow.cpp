    ...
    , ui(new Ui::MainWindow)
{
    ...
    InputStarTier = new QLabel("Tier: ",starDlg); InputStarTier->adjustSize();
...
void MainWindow::createRect()
{
   ...
   if (!matchHeight.hasMatch() || !matchWidth.hasMatch())
       QMessageBox::critical(rectDlg, "Error!", "Incorrect input");
   else {
       rectDlg->close();
...
void MainWindow::createTriang()
{
    ...
    if (!matchX1.hasMatch() || !matchX2.hasMatch() || !matchX3.hasMatch() ||
        ...
        QMessageBox::critical(triangDlg, "Error!", "Incorrect input");
    else {
        triangDlg->close();
...
void MainWindow::createCircle()
{
    ...
    if (!matchR.hasMatch())
        QMessageBox::critical(circleDlg, "Error!", "Incorrect input");
    else {
        circleDlg->close();
...
void MainWindow::createSquare()
{
    ...
    if (!matchA.hasMatch())
        QMessageBox::critical(squareDlg, "Error!", "Incorrect input");
    else {
        squareDlg->close();
...
void MainWindow::createRhomb()
{
    ...
    if (!matchr.hasMatch())
        QMessageBox::critical(rhombDlg, "Error!", "Incorrect input");
    else {
        rhombDlg->close();
...
void MainWindow::createOval()
{
    ...
    if (!matchOvalR.hasMatch() || !matchOvalr.hasMatch())
        QMessageBox::critical(ovalDlg, "Error!", "Incorrect input");
    else {
        ovalDlg->close();
...
void MainWindow::createStar()
{
    ...
    if (!matchStarR.hasMatch() || !matchStarr.hasMatch() || !matchStarTier.hasMatch()) {
        ...
        QMessageBox::critical(starDlg, "Error!", "Incorrect input");
    }
    else {
        starDlg->close();
...
void MainWindow::createHex()
{
    ...
    if (!matchHexR.hasMatch())
        QMessageBox::critical(hexDlg, "Error!", "Incorrect input");
    else {
        hexDlg->close();
